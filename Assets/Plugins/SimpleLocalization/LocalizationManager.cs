...
namespace Assets.SimpleLocalization
{
    ...
    public static class LocalizationManager
    {
        ...
        public static string Localize(string localizationKey)
        {
            ...
            if (!string.IsNullOrEmpty(Dictionary[Language][localizationKey]))
            {
            ...
            {
                if (!string.IsNullOrEmpty(Dictionary["English"][localizationKey]))
                {
                    return Dictionary["English"][localizationKey];
                }
                else
                {
                    ...
                    {
                        if (!string.IsNullOrEmpty(Dictionary[item][localizationKey]))
                        {
                      
                            return Dictionary[item][localizationKey];
                        }
                    }
                }
